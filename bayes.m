...
%分别计算在y1，y2，y3下的概率，
%首先使用全集开始测试
predictData=wine_data;
P_xy1=1;
P_xy2=1;
P_xy3=1;

for i=1:attributeNumber
    P_xy1=P_xy1 * normpdf(predictData(155,i),probability_1(1,i),probability_1(2,i));
    P_xy2=P_xy2 * normpdf(predictData(155,i),probability_2(1,i),probability_2(2,i));
    P_xy3=P_xy3 * normpdf(predictData(155,i),probability_3(1,i),probability_3(2,i));
end
